...
public class LevelLoaderScript : MonoBehaviour
{
    ...
    public static event Action TriggerRemovingWordsFromList;
    ...
    private void OnEnable()
    {
        ...
        InputScript.GoToSelectMenu += GoToSelectMenu;
        SelectMenuScript.LoadSelected += HandleSelectedLevel;
    }
    ...
    {                                               
        ...
        if (SceneManager.GetActiveScene().buildIndex > 2)
            TriggerRemovingWordsFromList?.Invoke();
    }

    private void HandleSelectedLevel(int sceneBuildIndex)
    {
    ...
    public void GoToSelectMenu()
    {
        ...
        if (InputScript.IsSelectedLevel) InputScript.IsSelectedLevel = false;
    ...
    private IEnumerator LoadLevel(int levelIndex)
    {
        ...
        //Load scene
        SpawningSystemScript.RestartingLevel = false;
    ...
    {
        SpawningSystemScript.RestartingLevel = true;
